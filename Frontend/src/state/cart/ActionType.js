...
export const ADD_ITEM_TO_CART_SUCCESSS = 'ADD_ITEM_TO_CART_SUCCESS'
export const ADD_ITEM_TO_CART_FAILURE = 'ADD_ITEM_TO_CART_FAILURE'

export const GET_CART_REQUEST = 'GET_CART_REQUEST'
export const GET_CART_SUCCESSS = 'GET_CART_SUCCESS'
export const GET_CART_FAILURE = 'GET_CART_FAILURE'

export const REMOVE_CART_ITEM_REQUEST = 'REMOVE_CART_ITEM_REQUEST'
export const REMOVE_CART_ITEM_SUCCESSS = 'REMOVE_CART_ITEM_SUCCESS'
...
export const UPDATE_CART_ITEM_SUCCESSS = 'UPDATE_CART_ITEM_SUCCESS'
