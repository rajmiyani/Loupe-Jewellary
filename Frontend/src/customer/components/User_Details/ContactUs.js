...
const ContactUs = () => {
  return (
    <div className='h-full bg-blue-50 w-full flex justify-center items-center flex-col gap-5'>
      <div className='text-center flex justify-center items-center flex-col gap-4'>
        <h1 className='text-5xl font-semibold' style={{ color: '#6a9eb5' }}>Help & Contact</h1>
        <h1 className='text-xl font-semibold text-center'>Feel free to ask any questions you may have. <br />We are here to help!</h1>
      </div>
      <div className='flex gap-3'>

        <div className='flex flex-col justify-center items-center pr-10 gap-2' style={{ borderRight: '2px solid #6a9eb5' }}>
          <img src="https://res.cloudinary.com/deq0hxr3t/image/upload/v1711683553/faq-phone_hxlyye.svg" alt="call" />
          <div className='flex flex-col justify-center items-center gap-1'>
            <h1 className='text-lg font-semibold text-center text-[#6a9eb5]'>Call Us At</h1>
        ...
        <div className='flex flex-col justify-center items-center gap-2 mt-1 pl-5'>
          ...
          <div className='flex flex-col justify-center items-center gap-1'>
            <h1 className='text-lg font-semibold text-center text-[#6a9eb5]'>Write to Us</h1>
