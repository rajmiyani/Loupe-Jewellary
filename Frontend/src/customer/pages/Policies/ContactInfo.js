    ...
    <Box sx={{ py: 10, bgcolor: '#fafafa', minHeight: '100vh' }}>
      <Container maxWidth="lg">
        <Box sx={{ textAlign: 'center', mb: 8 }}>
          <Typography variant="h3" sx={{ fontFamily: "'Playfair Display', serif", fontWeight: 800, color: '#755970', mb: 2 }}>
            Contact Us
          </Typography>
        ...
        <Grid container spacing={4}>
          <Grid item xs={12} md={4}>
            <Paper elevation={0} sx={{ p: 5, height: '100%', textAlign: 'center', borderRadius: '16px', border: '1px solid #f1f5f9', transition: 'transform 0.3s', '&:hover': { transform: 'translateY(-5px)', boxShadow: '0 20px 40px rgba(0,0,0,0.05)' } }}>
              <Box sx={{ width: 64, height: 64, borderRadius: '50%', bgcolor: '#f0f9ff', color: '#755970', display: 'flex', alignItems: 'center', justifyContent: 'center', mx: 'auto', mb: 3 }}>
                <LocationOnIcon fontSize="large" />
              </Box>
              <Typography variant="h6" sx={{ fontWeight: 700, color: '#755970', mb: 2 }}>
                Visit Our Boutique
              </Typography>
          ...
          <Grid item xs={12} md={4}>
            <Paper elevation={0} sx={{ p: 5, height: '100%', textAlign: 'center', borderRadius: '16px', border: '1px solid #f1f5f9', transition: 'transform 0.3s', '&:hover': { transform: 'translateY(-5px)', boxShadow: '0 20px 40px rgba(0,0,0,0.05)' } }}>
              ...
              <a href="mailto:loupejewelsllp@gmail.com" style={{ color: '#755970', fontWeight: 600, textDecoration: 'none' }}>
          ...
          <Grid item xs={12} md={4}>
            <Paper elevation={0} sx={{ p: 5, height: '100%', textAlign: 'center', borderRadius: '16px', border: '1px solid #f1f5f9', transition: 'transform 0.3s', '&:hover': { transform: 'translateY(-5px)', boxShadow: '0 20px 40px rgba(0,0,0,0.05)' } }}>
              ...
              <a href="tel:+919909109074" style={{ display: 'block', color: '#755970', fontWeight: 600, textDecoration: 'none', marginBottom: '8px' }}>
                +91 99091 09074
              </a>
