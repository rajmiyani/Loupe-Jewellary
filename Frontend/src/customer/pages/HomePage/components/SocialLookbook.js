        ...
        <section className="py-24 bg-white px-6 overflow-hidden">
            <div className="max-w-[1400px] mx-auto">
                <div className="text-center mb-16">
                    <span className="text-[#97c2d5] font-bold tracking-[0.2em] uppercase text-xs mb-3 block">Discover More</span>
                ...
                <div className="columns-1 sm:columns-2 lg:columns-3 gap-8 space-y-8">
                    {lookbookItems.map((img, idx) => (
                        ...
                        >
                            ...
                            />
                            <div className="absolute inset-0 bg-[#97c2d5]/10 opacity-0 group-hover:opacity-100 transition-opacity" />
                            <div className="absolute bottom-0 right-0 p-6">
                                <div className="w-10 h-10 rounded-full bg-white/90 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all transform translate-y-4 group-hover:translate-y-0">
                                    <span className="text-[#97c2d5] text-xs font-bold">♥</span>
                                </div>
                            </div>
                        </motion.div>
                    ))}
                ...
                <div className="mt-20 text-center">
                    ...
                    <button className="px-12 py-4 bg-gray-900 text-white font-bold uppercase tracking-[0.2em] text-xs hover:bg-[#97c2d5] transition-colors rounded-full shadow-lg">
                        Shop the Feed
                    </button>
                </div>
            </div>
