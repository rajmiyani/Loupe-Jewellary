            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    {services.map((service, index) => (
                        ...
                        >
                            <div className="w-16 h-16 rounded-full bg-white shadow-sm flex items-center justify-center mb-6 group-hover:bg-[#97c2d5] group-hover:text-white transition-all duration-500 transform group-hover:-translate-y-2 border border-neutral-100">
                                <service.Icon size={24} className="text-[#6a9eb5] group-hover:text-black transition-colors duration-500" />
                            </div>
