    ...
    return (
        <section className="py-20 bg-neutral-50 px-6">
            <div className="max-w-7xl mx-auto text-center">
                <span className="text-[#3c7399] font-bold tracking-[0.2em] uppercase text-xs mb-3 block">Pure Quality</span>
                ...
                <div className="flex flex-wrap justify-center gap-10 md:gap-20">
                    {metals.map((metal, index) => (
                        ...
                        >
                            ...
                            <h3 className="text-sm font-bold uppercase tracking-widest text-gray-700 group-hover:text-[#3c7399] transition-colors">{metal.name}</h3>
                            <div className="w-0 h-[2px] bg-[#3c7399] group-hover:w-full transition-all duration-300 mt-2" />
                        </motion.div>
                    ))}
                </div>
            </div>
